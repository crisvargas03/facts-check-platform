...
import { Badge, DataTable, EyeIcon, Modal } from '@/components/ui/shared';
		...
		const factors = [
			{
				...
				description:
					'Evaluación de la reputación y confiabilidad de la fuente',
			},
			{
				name: 'Evidencia Científica',
				score: Math.floor(Math.random() * 30) + 60,
				description:
					'Presencia de datos, estudios o referencias científicas',
			},
			{
				name: 'Citas y Referencias',
				score: Math.floor(Math.random() * 30) + 60,
				description:
					'Calidad y cantidad de citas y referencias incluidas',
			},
			{
				name: 'Lenguaje Objetivo',
				score: Math.floor(Math.random() * 30) + 60,
				description: 'Uso de lenguaje neutral y factual vs. emocional',
			},
			{
				name: 'Contexto y Limitaciones',
				score: Math.floor(Math.random() * 30) + 60,
				description:
					'Inclusión de contexto y reconocimiento de limitaciones',
			},
		];
			...
			{historialData.length === 0 && (
				<div
					...
					<p style={{ color: '#6b7280', marginBottom: '24px' }}>
						Aún no has analizado ningún artículo.
					</p>
					<a
						href='/submit-article'
						style={{
						...
						<div
							...
							<div
								style={{
									...
									fontWeight: 'bold',
									...getResultColor(
										selectedItem.credibilidad
									),
								}}>
								{selectedItem.porcentaje} de Veracidad
							</div>
							<p style={{ marginTop: '16px', color: '#6b7280' }}>
								{selectedItem.credibilidad >= 80 &&
									'El artículo tiene alta credibilidad'}
								{selectedItem.credibilidad >= 60 &&
									selectedItem.credibilidad < 80 &&
									'El artículo tiene credibilidad moderada'}
								{selectedItem.credibilidad >= 40 &&
									selectedItem.credibilidad < 60 &&
									'El artículo tiene credibilidad cuestionable'}
								{selectedItem.credibilidad < 40 &&
									'El artículo tiene baja credibilidad'}
							</p>
						</div>
